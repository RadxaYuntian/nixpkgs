...
in
{
  ...
  ubootRock3A = buildUBoot {
    defconfig = "rock-3a-rk3568_defconfig";
    extraMeta.platforms = [ "aarch64-linux" ];
    BL31 = "${armTrustedFirmwareRK3568}/bl31.elf";
    ROCKCHIP_TPL = rkbin.TPL_RK3568;
    filesToInstall = [
  ...
  ubootRadxaE25 = buildUBoot {
    defconfig = "radxa-e25-rk3568_defconfig";
    extraMeta.platforms = [ "aarch64-linux" ];
    BL31 = "${armTrustedFirmwareRK3568}/bl31.elf";
    ROCKCHIP_TPL = rkbin.TPL_RK3568;
    filesToInstall = [
  ...
  ubootRock5ITX = buildUBoot {
    defconfig = "rock-5-itx-rk3588_defconfig";
    extraMeta.platforms = [ "aarch64-linux" ];
    BL31 = "${armTrustedFirmwareRK3588}/bl31.elf";
    ROCKCHIP_TPL = rkbin.TPL_RK3588;
    filesToInstall = [
